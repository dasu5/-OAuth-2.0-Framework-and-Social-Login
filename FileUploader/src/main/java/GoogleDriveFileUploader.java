...
public class GoogleDriveFileUploader {
    ...
    private static final String APPLICATION_NAME = "Google Drive File Uploader";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GoogleDriveFileUploader.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
